package com.sgsavch.toolsrent.configuration;

import com.sgsavch.toolsrent.handler.CustomAccessDeniedHandler;
import com.sgsavch.toolsrent.handler.CustomAuthenticationEntryPoint;
...
public class SecurityConfig {
    ...
    public SecurityFilterChain securityFilterChain(HttpSecurity http) throws Exception {
        ...
        http.authorizeHttpRequests().requestMatchers(DELETE, "/tool/delete/**").hasAnyAuthority("DELETE:TOOL");
